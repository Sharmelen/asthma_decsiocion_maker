...
def alert_result():
	...
	st1 = wx.StaticText(win, label = "Alert")
	st1.SetFont(font)
	...
	st3 = wx.StaticText(win, label = "  - Symptoms Are Worsening (Cough, Wheeze, Chest Tightness or Shortness of Breath)")
	st3.SetFont(font)
	hbox3.Add(st3, flag = wx.RIGHT, border = 8)
	vbox.Add(hbox3, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=10)
	
	hbox4 = wx.BoxSizer(wx.HORIZONTAL)
	st4 = wx.StaticText(win, label = "  - You Are Using Your Reliever Frequently:")
	st4.SetFont(font)
	hbox4.Add(st4, flag = wx.RIGHT, border = 8)
	vbox.Add(hbox4, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=10)
	
	hbox5 = wx.BoxSizer(wx.HORIZONTAL)
	st5 = wx.StaticText(win, label = "   - Every 2 to 3 hours")
	st5.SetFont(font)
	hbox5.Add(st5, flag = wx.RIGHT, border = 8)
	vbox.Add(hbox5, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=10)
	
	hbox6 = wx.BoxSizer(wx.HORIZONTAL)
	st6 = wx.StaticText(win, label = "   - More Than 8 Puffs A Day")
	st6.SetFont(font)
	...
	st8 = wx.StaticText(win, label = "  - Take Your Regular Medications ")
	st8.SetFont(font)
	...
	st9 = wx.StaticText(win, label = "  - Start Pedrisolone NOW 2 Tablets Daily (Maximum 50mg/Day)")
	st9.SetFont(font)
	hbox9.Add(st9, flag = wx.RIGHT, border = 8)
	vbox.Add(hbox9, flag=wx.EXPAND|wx.LEFT|wx.RIGHT|wx.TOP, border=10)
	
	hbox10 = wx.BoxSizer(wx.HORIZONTAL)
	st10 = wx.StaticText(win, label = "  - Go To The Nearest Hospital Or Clinic IMMEDIATELY/Dial 999")
	st10.SetFont(font)
